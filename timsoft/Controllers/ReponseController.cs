...
namespace timsoft.Controllers
{
    ...
    public class ReponseController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("AddReponse")]
        public ActionResult AddReponse(ReponseForm reponse)
        {
        ...
        {
            return Ok(reponseService.DeleteReponse(id));
        }
        [HttpPut]
        [Route("UpdateReponse")]
        public ActionResult UpdateReponse(ReponseForm reponse, int id)
        {
